...
View(BioTrap_OTUabs)#this includes all OTUs with taxonomic data but no diff between Axial and Loihi. Also includes the size of each OTU (which is the sum of all counts for that OTU)
